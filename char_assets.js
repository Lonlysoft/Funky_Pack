const Characters = {
	Dynny:{
		...
		animations: {
			walk: ["infinite", 3, 3, 3, 3, 3, 4, 4, 4, 4, 4, 3, 3, 3, 3, 0, 0, 0, 0, "m", 3, "m", 3, "m", 3, "m", 3, "m", 3, "m", 4, "m", 4, "m", 4, "m", 4, "m", 4, "m", 3, "m", 3, "m", 3, "m", 3, "m", 3, 0, 0, 0, 0],
			walkDifferent: ["infinite", 3, 3, 3, 3, 3, 0, 0, 0, 0, 0, 5, 5, 5, 5, 5, 0, 0, 0, 0, 0],
			still: ["infinite", 0],
			jump: ["linear", 3, 3, 4, 4, 4, 4, 4],
